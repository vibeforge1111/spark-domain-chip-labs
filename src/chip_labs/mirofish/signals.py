...
SIGNAL_TYPES: dict[str, dict[str, Any]] = {
    ...
    "live_twitter": {
        "label": "Live X/Twitter Signal",
        "default_strength": 0.5,
        "decay_per_round": 0.12,
        "description": "Real-time signal from X/Twitter data. Fast decay (live data ages quickly).",
    },
}
...
SHOCK_TEMPLATES: dict[str, dict[str, Any]] = {
    "market_crash": {
        ...
        "affected_persona_types": ["investor", "trader", "entrepreneur"],
        "effect": "negative",
    ...
    "breakout_tool": {
        ...
        "affected_persona_types": ["opportunity_hunter", "developer", "tool_maker", "ai_newcomer"],
        "effect": "positive",
    ...
    "viral_adoption": {
        ...
        "affected_persona_types": ["content_creator", "opportunity_hunter", "marketer", "creative"],
        "effect": "positive",
    ...
    "ecosystem_integration": {
        ...
        "affected_persona_types": ["developer", "tool_maker", "solopreneur"],
        "effect": "positive",
...
def create_signal(
    ...
    return {
        ...
        "strength": strength if strength is not None else type_info.get("default_strength", 0.5),
...
def create_shock(
    ...
    shock = {
        ...
        "strength": strength_override if strength_override is not None else template.get("strength_override", 0.8),
