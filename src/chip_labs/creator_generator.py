...
def _compute_reports(run_path: Path) -> dict[str, Any]:
    ...
    if not baseline_scores:
        return {
            ...
            "candidate": {"mean_score": 0.0, "mean_delta": 0.0, "lane_results": {}},
            "absorption": {"mean_validated_pack_delta": 0.0, "trap_band_case_count": 0, "lane_results": {}},
        }
...
def _seeded_brief_variant(
    ...
    raise RuntimeError(f"Creator generator: failed to serialize/deserialize brief: {exc}") from exc
