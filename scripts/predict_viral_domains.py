...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Run the MiroFish viral-domain prediction")
    parser.add_argument(
        "--output",
        default=os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "viz", "viral_predictions.json"),
