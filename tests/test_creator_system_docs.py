...
def test_swarm_reusable_creator_path_keeps_review_bundle_local() -> None:
    ...
    for phrase in (
        ...
        "github-ruleset-review.template.json",
        "github-ruleset-review.current.json",
        "sharing-preference.template.json",
        "artifact-attestation-readiness.template.json",
        ...
        "publication approval",
        "revocation",
        "artifact attestation readiness",
        "actions/attest",
        "id-token: write",
...
def test_schema_readme_lists_generated_multi_seed_schema_anchors() -> None:
    ...
    for phrase in (
        ...
        "specialization-loop-status.schema.json",
        "specialization-loop-insight-packet.schema.json",
        "Local/private specialization insight packet",
        "saved status packet hash",
