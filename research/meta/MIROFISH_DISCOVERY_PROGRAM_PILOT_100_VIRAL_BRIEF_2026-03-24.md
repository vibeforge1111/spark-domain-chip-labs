# MiroFish Discovery Pilot 100 Viral Brief
...
- `creator-growth-systems`: Creator Growth Systems (16 agents)
...
- `gaming-npc-community`: Gaming / NPC / Community Worlds (14 agents)
...
- `agentic-builders`: AI Agent Builders (12 agents)
...
- `startup-founder-systems`: Startup Builder Systems (12 agents)
...
- `productivity-builder-ops`: Builder Productivity Systems (10 agents)
...
- `career-status-social-proof`: Career / Status / Social Proof (10 agents)
...
- `consumer-agent-utilities`: Consumer Agent Utilities (8 agents)
...
- `crypto-defi-trading`: Crypto / DeFi / Trading (8 agents)
...
- `x-native-persona-tools`: X-Native Persona Tools (6 agents)
...
- `design-remix-aesthetics`: Design / Remix / Aesthetics (4 agents)
