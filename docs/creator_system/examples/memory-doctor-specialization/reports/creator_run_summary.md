...
- Live local run shows active operator_label is operator and Assistant appears only in recent trace matches, while the historical multi-delete bug remains visible as a delete-integrity failure.
