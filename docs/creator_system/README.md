...
| [schemas/](schemas/) | JSON Schema anchors for creator intent, adapter map, smoke, doctor, template-check, Swarm packet, mission-status, and Startup YC validation plan, evidence, shape-check, gate-check, and suite outputs. |
