...
| [NATURAL_LANGUAGE_RECURSIVE_LOOP_GUIDE.md](NATURAL_LANGUAGE_RECURSIVE_LOOP_GUIDE.md) | Public product guide for turning normal Telegram conversation into domain chips, benchmark packs, specialization paths, autoloops, recursive reports, and private review packets without overclaiming Spark Swarm publication. |
...
| [CONTRIBUTING_CREATOR_DOMAINS.md](CONTRIBUTING_CREATOR_DOMAINS.md) | Contributor path for proposing new creator-system domains with smoke, doctor, recompute, rollback, and local Swarm packet evidence. |
| [CREATOR_SYSTEM_SWARM_REUSE_END_TO_END_PLAN.md](CREATOR_SYSTEM_SWARM_REUSE_END_TO_END_PLAN.md) | Active end-to-end task plan for finishing the reusable Spark Swarm creator path while preserving blocked network absorption. |
| [CREATOR_SYSTEM_SWARM_REUSE_EXECUTION_EVIDENCE_2026-05-05.md](CREATOR_SYSTEM_SWARM_REUSE_EXECUTION_EVIDENCE_2026-05-05.md) | Fresh-clone verification, Generated matrix JSON release-asset policy, local inventory report, and blocked future promotion bundle plan. |
| [CREATOR_SYSTEM_SPARK_SWARM_ALIGNMENT_AND_LAUNCH_TASKS.md](CREATOR_SYSTEM_SPARK_SWARM_ALIGNMENT_AND_LAUNCH_TASKS.md) | Cross-repo alignment plan and launch task system for private workspace sync, public network proposals, privacy, security, UX, and scalability. |
| [CREATOR_SYSTEM_SPARK_SWARM_PHASED_BUILD_PLAN.md](CREATOR_SYSTEM_SPARK_SWARM_PHASED_BUILD_PLAN.md) | Phase-by-phase build plan for converting the alignment tasks into tested schemas, examples, dry-run payloads, privacy gates, launch rehearsal, and hardening checks. |
| [CREATOR_SYSTEM_SPARK_SWARM_LAUNCH_REHEARSAL_2026-05-05.md](CREATOR_SYSTEM_SPARK_SWARM_LAUNCH_REHEARSAL_2026-05-05.md) | Startup YC launch rehearsal evidence for smoke, doctor, Collective dry-run payload, blocked proposal contracts, and no automatic publish. |
| [CREATOR_SYSTEM_SPARK_SWARM_POST_P8_CLEAN_CLONE_REHEARSAL_2026-05-05.md](CREATOR_SYSTEM_SPARK_SWARM_POST_P8_CLEAN_CLONE_REHEARSAL_2026-05-05.md) | Clean-clone post-P8 rehearsal proving the committed private workspace/proposal path, canonical text artifact hashes, and blocked network absorption. |
| [SPARK_SWARM_LAUNCH_HARDENING_CHECKLIST.md](SPARK_SWARM_LAUNCH_HARDENING_CHECKLIST.md) | P8 supply-chain, privacy, scalability, UX, payload-budget, and launch-rehearsal gates before Spark Swarm launch integration. |
| [SPARK_SWARM_PROPOSAL_STATUS_UX_HANDOFF.md](SPARK_SWARM_PROPOSAL_STATUS_UX_HANDOFF.md) | Product-copy handoff for rendering private, workspace-validated, proposal-blocked, proposal-submitted, reviewed-candidate, and future network-absorbable creator states without implying publication approval. |
| [CREATOR_SYSTEM_SWARM_REUSABILITY_TASKS.md](CREATOR_SYSTEM_SWARM_REUSABILITY_TASKS.md) | Task ledger for making creator-system domains reusable in Spark Swarm without claiming network absorption. |
| [SWARM_REUSABLE_CREATOR_PATH.md](SWARM_REUSABLE_CREATOR_PATH.md) | Local review-bundle path for packaging creator-run evidence, Swarm packets, mission status, and replay commands for Spark Swarm review. |
...
| [PUBLIC_BETA_RELEASE_HANDOFF_2026-05-04.md](PUBLIC_BETA_RELEASE_HANDOFF_2026-05-04.md) | Public-facing beta handoff with first commands, verified evidence, release-shape decision, and production upgrade gates. |
...
| [examples/swarm-review-bundles/](examples/swarm-review-bundles/) | Example local Swarm review bundles for packaging creator-run evidence without approving network absorption. |
...
| Check honest 100% repo/user beta and creator-system standard readiness | `python -m chip_labs.cli creator-system-production-readiness --fail-on-blocked --output /tmp/creator-system-production-readiness.json` |
...
| Run Startup YC production-gate workbench | `python -m chip_labs.cli startup-yc-production-gate-workbench --validation-plan docs/creator_system/examples/startup-yc-operator-validation/validation_plan.json --workspace-dir /tmp/startup-yc-production-gate-workbench --output /tmp/startup-yc-production-gate-workbench.json` |
